...
<div class="navbar navbar--extended">
    ...
    <div class="container">
        <div class="navbar__inner text-left">
            <a href="{{route('ٔNeedLogin')}}"  class="btn btn-sm button hero__button" >پنل کاربری نیازمندان</a>
            <a href="{{route('CustomLogin')}}"  class="btn btn-sm button button__accent" >پنل کاربری خیرین</a>
            <a href="{{route('login')}}"  class="btn btn-sm button button__accent" >پنل مدیریت </a>
        </div>
    </div>
</div>
<!-- Hero unit -->
