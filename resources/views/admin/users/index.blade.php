...
@section('position')
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1 class="m-0 text-dark">اعضا</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-left">
                <li class="breadcrumb-item"><a href="{{route('adminPanel')}}">خانه</a></li>
                <li class="breadcrumb-item active">اعضا</li>
            </ol>
        </div><!-- /.col -->
    </div>
@endsection
        ...
        <div class="col-md-12">
            <div class="card card-primary card-outline">
                <div class="card-header">
                    <h3 class="card-title d-inline">لیست اعضا
                    </h3>
                    <a href="{{route('user.create')}}" class="btn btn-sm btn-primary d-inlie" style="float: left">
                        ایجاد عضو جدید
                    </a>
                    ...
                    <table class="table table-striped" id="table-data2">
                        ...
                        @foreach($users as $l =>$val)
                            <tr>
                                ...
                                <td>
                                    {{\App\Models\UserGroup::where('user_id',$val->id)->count()}}
                                </td>
                                <td>
                                    <a class="btn btn-sm btn-warning" href="{{route('user.edit',$val->id)}}">
                        ...
                        <tr>
                            ...
                            <th class="">
                                <input id="title" class="form-control" type="text" placeholder="ایمیل">
                            </th>
                            <th class="filter">
                            </th>
                            <th class="">
